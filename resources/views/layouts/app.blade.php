...
<head>
    ...
    <title>{{ config('app.name', 'Gestión de Eventos') }}</title>
                    ...
                    <ul class="navbar-nav me-auto">
                        @auth
                            @if(Auth::user()->rol === 'administrador')
                                <li class="nav-item">
                                    <a class="nav-link text-white" href="{{ route('usuarios.create') }}">Usuarios</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link text-white" href="{{ route('eventos.create') }}">Eventos</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link text-white" href="{{ route('inscripcions.create') }}">Inscripciones</a>
                                </li>
                                <li class="nav-item">
                            ...
                            @elseif(Auth::user()->rol === 'participante')
                                <li class="nav-item">
                                    <a class="nav-link text-white" href="{{ route('inscripciones.create') }}">Inscribirse a Evento</a>
                                </li>
                            @endif
                        @endauth
                    </ul>
